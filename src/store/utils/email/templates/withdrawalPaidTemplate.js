exports.withdrawalPaidTemplate = ({
  vendorName,
  amount,
  withdrawalId,
  paidDate,
          ...
          <tr>
            <td style="padding:34px 30px; color:#1f2937;">
              ...
              <p style="font-size:15px; line-height:1.6;">
                ...
                <strong style="color:#16a34a;">withdrawal payment has been successfully processed</strong>.
              </p>
              ...
              <!-- INFO BOX -->
              <table width="100%" style="background:#f0fdf4;
                border:1px solid #bbf7d0; border-radius:12px; margin:24px 0;">
                <tr>
                  <td style="padding:20px;">
                    <p style="margin:0; font-size:14px; line-height:1.6;">
                      💳 The amount has been credited to your
                      <strong>registered bank account</strong>.
                      If you do not see the credit immediately, please allow some time as per your bank’s processing rules.
                    </p>
                  </td>
                </tr>
              </table>
