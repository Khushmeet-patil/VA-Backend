...
export interface IFeatureUsage extends Document {
    feature: 'numerology' | 'lal_kitab' | 'kundli' | 'horoscope' | 'panchang' | 'matching';
    userId?: mongoose.Types.ObjectId;
    createdAt: Date;
}

const FeatureUsageSchema: Schema = new Schema({
    feature: { type: String, enum: ['numerology', 'lal_kitab', 'kundli', 'horoscope', 'panchang', 'matching'], required: true },
